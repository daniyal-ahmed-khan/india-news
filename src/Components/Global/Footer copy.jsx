    ...
    !loading && (
      <div className="footer-main-container">
        ...
        <div className="footer-checkup-main-conatiner">
          ...
          <div className="footer-main">
            <div className="footer-item-box">
              <div style={{cursor:'pointer'}} onClick={()=>Navigation("itempage?item=Lifestyle")} className="footer-heading">{CategoryData[5]?.label}</div>
              {/* <div className="footer-items">
            ...
            <div className="footer-item-box">
              <div style={{cursor:'pointer'}} onClick={()=>Navigation("itempage?item=Health")} className="footer-heading">{CategoryData[6]?.label}</div>
              {/* <div className="footer-items">
                <div>with us</div>
                <div>on earth </div>
            ...
            <div className="footer-item-box">
              <div style={{cursor:'pointer'}} onClick={()=>Navigation("itempage?item=Education")} className="footer-heading">{CategoryData[7]?.label}</div>
              {/* <div className="footer-items">
                <div>environment</div>
            ...
            <div className="footer-item-box">
              <div style={{cursor:'pointer'}} onClick={()=>Navigation("itempage?item=Foreign")} className="footer-heading">{CategoryData[8]?.label}</div>
              {/* <div className="footer-items">
                <div>designs</div>
                <div>membership </div>
                <div>investment </div>
            ...
            <div className="footer-item-box">
              <div style={{cursor:'pointer'}} onClick={()=>Navigation("itempage?item=Desh")} className="footer-heading">{CategoryData[9]?.label}</div>
              {/* <div className="footer-items">
                <div>america</div>
                <div>russia </div>
                <div>bhutan</div>
